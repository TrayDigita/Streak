...
class MakeACLAccess extends MakeClassCommand
{
    protected string $command = 'acl:access';
    protected string $type = 'access acl';
    protected string $accessDirectory = '';
    protected string $classNamespace = 'TrayDigita\\Streak\\ACL\\Access';
    ...
    protected function configure()
    {
        ...
        $this->accessDirectory = "$appDir{$ds}ACL{$ds}Access";
    }
    ...
    protected function doGeneration(string $namespace, string $name, SymfonyStyle $symfonyStyle): int
    {
        ...
        if (!$this->isQuiet) {
            ...
            $directoryText = $this->translate('ACL Access directory');
 ...
 * @generated $date
 */
class $name extends AbstractAccess
{
   /**
    * ACL Access Identity
    * @param string
